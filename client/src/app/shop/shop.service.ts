...
export class ShopService {
  ...
  getProduct(id: number) {
    ...
    return this.http.get<IProduct>(this.basesUrl + 'products/' + id);
  }
  ...
  getBrands() {
    ...
    return this.http.get<IBrand[]>(this.basesUrl + 'products/brands').pipe(
      map((response) => {
  ...
  getTypes() {
    ...
    return this.http.get<IType[]>(this.basesUrl + 'products/types').pipe(
      map((response) => {
        this.types = response;
        return response;
      })
